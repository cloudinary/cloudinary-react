...
import {photosUploaded, deleteUploadedPhoto} from "../actions";
...
class UploadedPhotoStatus extends Component {
    ...
    deletePhoto() {
        request.post(`https://api.cloudinary.com/v1_1/${this.context.cloudName}/delete_by_token`)
...
UploadedPhotoStatus.contextTypes = {cloudName: PropTypes.string, uploadPreset: PropTypes.string};
