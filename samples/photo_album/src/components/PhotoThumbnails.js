...
const transformations = [
    ...
    [{crop: 'fill', effect: 'sepia', gravity: 'north', width: '150', height: '150', radius: '20'}, {angle: '20'}]
];
                ...
                transformations.map((transformation) => {
                    return (<td>
                        <div className="thumbnail_holder">
                            <Image publicId={publicId} className="thumbnail inline" format="jpg">
                                {
                                    transformation.map((subTransformation, index) => {
                                        return (<Transformation {...subTransformation}  key={index}/>);
                                    })
                                }
                            </Image>
                        </div>
