...
class Image extends CloudinaryComponent {
  ...
  getOptions = () => {
    ...
    const { children, innerRef, ...options } = {
      ...extendedProps,
      ...this.getTransformation(extendedProps)
    }
  ...
  getAttributes = (additionalOptions = {}) => {
    ...
    const options = extractCloudinaryProps({
      ...this.getOptions(),
      ...additionalOptions
    })
    const {
  ...
  update = () => {
    ...
    if (this.shouldLazyLoad()) {
      ...
      if (this.isResponsive()) {
        ...
        if (placeholder) {
          const removePlaceholderListener = makeElementResponsive(
            this.placeholderElement.current,
            { ...options, placeholder }
          )
        ...
        const removeImgListener = makeElementResponsive(
...
Image.defaultProps = {}
Image.propTypes = getTransformationPropTypes()
